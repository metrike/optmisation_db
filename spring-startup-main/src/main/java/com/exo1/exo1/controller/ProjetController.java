...
public class ProjetController {
    ...
    @GetMapping("/findByIdWithTasks/{id}")
    public ResponseEntity<ProjetDto> findByIdWithTasks(@PathVariable Long id) {
        return ResponseEntity.ok(projetService.findByIdWithTasks(id));
    }
}
